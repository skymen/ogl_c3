...
const Config = {
  ...
  fileDependencies: [
    {
      filename: "ogl.js", // no need to include "c3runtime/" prefix
      type:
        //"copy-to-output"
        "inline-script",
      //"external-dom-script"
  ...
  properties: [
    ...
    */
    ...
    },
    {
      ...
      name: "Depth",
      desc: "Wether to use a depth buffer",
    },
    {
      type: "check",
      id: "stencil",
      ...
      name: "Stencil",
      desc: "Wether to use a stencil buffer",
    },
    {
      type: "check",
      id: "autoClear",
